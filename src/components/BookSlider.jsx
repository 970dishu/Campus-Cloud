...
//                   <h3 className="text-3xl font-bold mb-4">{bookCategories[currentIndex].type}</h3>
//                   <p className="text-gray-600 mb-4">{bookCategories[currentIndex].description}</p>
//                   <h4 className="text-xl font-semibold mb-2">Benefits:</h4>
//                   <p className="text-gray-600 mb-4">{bookCategories[currentIndex].benefits}</p>
//                   <h4 className="text-xl font-semibold mb-2">Notable Examples:</h4>
//                   <ul className="list-disc list-inside mb-4">
//                     {bookCategories[currentIndex].examples.map((book, index) => (
//                       <li key={index} className="text-gray-600">{book}</li>
//                     ))}
//                   </ul>
//                   <h4 className="text-xl font-semibold mb-2">Famous Authors:</h4>
...
//           <button
//             onClick={prevSlide}
//             className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-[#E1AA4D] text-white p-2 rounded-full shadow-lg hover:bg-[#C58940] transition-colors"
//           >
//             <ChevronLeft size={24} />
//           </button>
//           <button
//             onClick={nextSlide}
//             className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-[#E1AA4D] text-white p-2 rounded-full shadow-lg hover:bg-[#C58940] transition-colors"
//           >
...
//                 index === currentIndex ? 'bg-[#E1AA4D]' : 'bg-gray-300'
//               }`}
//             />
//           ))}
//         </div>
